...
四. 总结
业务方向
Rust语言的独特优势以及在前端生态能力上的逐渐完善，越来越多的业务场景都用了Rust来扩展我们的JS能力
厂内：
* 凤巢前端将调用频次高的热点函数通过Rust实现，通过napi-rs进行打包：
[【2024.03.13】Rust扩展在Node.js中的应用](https://ku.baidu-int.com/knowledge/HFVrC7hq1Q/MUyZ7Y-BGz/0eHeaiwzQ0/2e74f564f45f46)
* 利用webassembly的高性能实现特征点检测，虽然它是通过C 来编译成WASM的：
[WEB世界的一扇窗---从一个真实需求看WebAssembly的应用](https://ku.baidu-int.com/knowledge/HFVrC7hq1Q/5PohCU7HAz/Hb94Bhd9BC/i9_3Le8m7eQ-jf)
外部：
* 抖音IM软件重构：[Rust语言在IM客户端的实践](https://juejin.cn/post/7336022842856177690?searchId=20240823012721791F00E88C7EB7B3197B)
* 京东3D模型计算：[给 Web 前端工程师看的用 Rust 开发 wasm 组件实战](https://juejin.cn/post/7308434321764794378#heading-5)
* Rspack 支持 JS 编写 loader 和 plugin (napi-rs)
* ......
当JS执行的性能达到瓶颈时，我们也可以换个角度思考，利用Rust的独特优势来进行优化CPU密集型的任务
Rust学习感悟
1. 多利用GPT，不懂的代码/报错可以向GPT的提问，大部分给的思路和方向都是正确的
2. 多在githhub参考别人的代码，不需要全部看懂，只需要关注部分实现，逻辑打通即可
3. 当以上都还没解决你的问题时，尝试在github相关仓库提问
